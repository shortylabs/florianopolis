...
public class SundayFragment extends Fragment {
    ...
    private static final String TAG = SundayFragment.class.getSimpleName();
    ...
    private void showResults() {
        ...
        if (departures != null && departures.rows.size() > 0 && departures.sunday().size() > 0) {
            ...
            Toast.makeText(getActivity(),
                    getString(R.string.format_no_sunday_departures),
    ...
    static class MessengerHandler extends Handler {
        ...
        WeakReference<SundayFragment> outerClass;
         ...
         */
        public MessengerHandler(SundayFragment outer) {
            outerClass = new WeakReference<SundayFragment>(outer);
        }
        ...
        public void handleMessage(Message msg) {
            ...
            final SundayFragment sundayFragment = outerClass.get();

            // If SundayFragment hasn't been garbage collected
            // (closed by user), proceed.
            if (sundayFragment != null && sundayFragment.getActivity() != null) {
                ...
                if (data.containsKey(RouteService.EXTRA_DEPARTURES_BY_ROUTEID_KEY)) {
                    sundayFragment.setJsonResult(data.getString(RouteService.EXTRA_DEPARTURES_BY_ROUTEID_KEY));
